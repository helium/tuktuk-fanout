...
import { init as initFanout, queueAuthorityKey, tokenInflowKey, voucherKey } from '@helium/wallet-fanout-sdk'
    ...
    async () => {
      ...
      for (const share of shares) {
        ...
        for (const inflow of inflows) {
          ...
          const voucherAddr = voucherKey(fanout, inflow.info.mint, walletShare)[0]
